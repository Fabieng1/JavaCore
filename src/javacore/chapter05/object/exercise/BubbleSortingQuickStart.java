...
public class BubbleSortingQuickStart {
    ...
    public static void main(String[] args) {
        ...
        int[] tempsNumberDown = new int[numbers.length / 2];
        int[] tempsNumberUp = new int[numbers.length / 2];
        int[] tab = {};
        ...
        for (int indexVerif = 0; indexVerif < numbers.length; indexVerif++) {
            for (indexNumbers = 0; indexNumbers < numbers.length - 1; indexNumbers++) {
                ...
                if (numbers[indexNumbers] >= numbers[numberRandom]) {
                    ...
                    tempsNumberUp[indexNumbers - 1] = numbers[indexNumbers];
                }
                else if (numbers[indexNumbers] < numbers[numberRandom]) {
