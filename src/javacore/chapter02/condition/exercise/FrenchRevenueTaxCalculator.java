...
public class FrenchRevenueTaxCalculator {
    ...
    public static void main (String[] args) {
        ...
        if (salaryAnnualNetTaxableAfterReduction < 29315.0) {
            salaryAnnualNetTaxableAfterReduction = salaryAnnualNetTaxableAfterReduction - 29315.0;
        ...
        if (salaryAnnualNetTaxableAfterReduction < 83823) {
            salaryAnnualNetTaxableAfterReduction = salaryAnnualNetTaxableAfterReduction - 83823;
        ...
        if (salaryAnnualNetTaxableAfterReduction <= 180294) {
            salaryAnnualNetTaxableAfterReduction = salaryAnnualNetTaxableAfterReduction - 180294;
