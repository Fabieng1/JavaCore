...
public class FrenchRevenueTaxCalculator {
    ...
    public static void main (String[] args) {
        ...
        double salaryAnnualNetTaxableAfterReduction = 0;
        ...
        if (salaryAnnualNetTaxableAfterReduction < 29315.0) {
            taxableRemainder5 = salaryAnnualNetTaxableAfterReduction - reduction;
        ...
        if (salaryAnnualNetTaxableAfterReduction < 83823) {
            taxableRemainder3 = salaryAnnualNetTaxableAfterReduction - reduction;
        ...
        if (salaryAnnualNetTaxableAfterReduction <= 180294) {
            taxableRemainder4 = salaryAnnualNetTaxableAfterReduction - reduction;
